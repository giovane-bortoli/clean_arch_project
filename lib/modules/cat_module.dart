...
import 'package:clean_arch_project/features/list_cats/data/data_sources/cat_list_local_data_source_impl.dart';
...
class CatModule extends Module {
  ...
  List<Bind<Object>> get binds => [
        ...
        Bind.factory<CatListLocalDataSource>((i) => CatListLocalDataSourceImpl(hiveStorage: i()), export: true),
        Bind.factory<CatRepository>(
            (i) => CatRepositoryImpl(localDataSource: i(), remoteDataSource: i(), connectionService: i()),
            export: true),
